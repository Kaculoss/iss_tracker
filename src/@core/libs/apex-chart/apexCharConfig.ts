...
export const getBoxplotChartConfig = (themeColors: ThemeInstance['themes']['value']['colors']) => {
  const boxPlotColors = {
    series1: '#28c76f',
    series2: '#ea5455'
  }
  ...
  return {
    ...
    plotOptions: {
      ...
      boxPlot: {
        colors: {
          upper: boxPlotColors.series1,
          lower: boxPlotColors.series2
        }
      }
    },
    stroke: {
...
export const getAreaChartSplineConfig = (themeColors: ThemeInstance['themes']['value']['colors']) => {
  ...
  return {
    ...
    xaxis: {
      ...
      categories: ['7/12', '8/12', '9/12', '10/12', '11/12', '12/12', '13/12', '14/12', '15/12', '16/12', '17/12', '18/12', '19/12']
    }
  }
}
